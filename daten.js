...
;(function (root, factory) {
  ...
  var TAU_RATIO = {
    stahl:     { ratio: 0.62, rmDefault: 600, grade: 'C45 vergütet',   label: { de: 'Stahl (verguetet/gehaertet)', en: 'steel (quenched & tempered)', pt: 'aço (temperado e revenido)' } },
    stahl_bau: { ratio: 0.65, rmDefault: 360, grade: 'S235',           label: { de: 'Bau-/Automatenstahl', en: 'structural/free-cutting steel', pt: 'aço estrutural/de corte livre' } },
    gjs:       { ratio: 0.90, rmDefault: 400, grade: 'GJS-400',        label: { de: 'Sphaeroguss GJS', en: 'nodular cast iron GJS', pt: 'ferro fundido nodular GJS' } },
    gjl:       { ratio: 1.10, rmDefault: 250, grade: 'GJL-250',        label: { de: 'Grauguss GJL', en: 'grey cast iron GJL', pt: 'ferro fundido cinzento GJL' } },
    alu_guss:  { ratio: 0.70, rmDefault: 200, grade: 'AlSi-Guss',      label: { de: 'Aluminium (Knet/Guss)', en: 'aluminium (wrought/cast)', pt: 'alumínio (forjado/fundido)' } },
    mg_guss:   { ratio: 0.70, rmDefault: 150, grade: 'Mg-Leg. AZ91',   label: { de: 'Magnesium-Legierung', en: 'magnesium alloy', pt: 'liga de magnésio' } }
  };
  var BOLT_TAU_RATIO = 0.62;   // tau_B,S / R_m,S der Schraube (Stahl, Richtwert)
  ...
  var PRESETS = {
    ...
    'grauguss_esv_m12': {
      ...
      input: {
        ...
        l_K: 30, d_w: 18, d_h: 13.5, D_A: 50, E_P: 110000, p_G: 700,
