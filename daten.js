...
;(function (root, factory) {
  ...
  var TAU_RATIO = {
    stahl:     { ratio: 0.62, label: { de: 'Stahl (verguetet/gehaertet)', en: 'steel (quenched & tempered)', pt: 'aço (temperado e revenido)' } },
    stahl_bau: { ratio: 0.65, label: { de: 'Bau-/Automatenstahl', en: 'structural/free-cutting steel', pt: 'aço estrutural/de corte livre' } },
    gjs:       { ratio: 0.90, label: { de: 'Sphaeroguss GJS', en: 'nodular cast iron GJS', pt: 'ferro fundido nodular GJS' } },
    gjl:       { ratio: 1.10, label: { de: 'Grauguss GJL', en: 'grey cast iron GJL', pt: 'ferro fundido cinzento GJL' } },
    alu_guss:  { ratio: 0.70, label: { de: 'Aluminium (Knet/Guss)', en: 'aluminium (wrought/cast)', pt: 'alumínio (forjado/fundido)' } },
    mg_guss:   { ratio: 0.70, label: { de: 'Magnesium-Legierung', en: 'magnesium alloy', pt: 'liga de magnésio' } }
  };
