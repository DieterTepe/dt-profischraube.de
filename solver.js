...
;(function (root, factory) {
  ...
  function computeJoint(inp) {
    ...
    notes.pending.push({ code: 'PENDING_R11', text: 'Mindesteinschraubtiefe (R11): Es soll eher die Schraube brechen als das Gewinde ausreissen. Diese Version schaetzt nur grob (~0,9*d). Bei Durchsteckschraube mit genormter Mutter passender Festigkeitsklasse ist das in der Regel erfuellt. Bei Einschraubung in weiches Material (Aluminium, Guss) auf ausreichende Einschraubtiefe achten (Richtwert Stahl ~1*d, Guss ~1,4*d, Aluminium ~2*d). Der genaue Nachweis folgt als Erweiterung.' });
