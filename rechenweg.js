  ...
  function build(R, inp, opts) {
    ...
    if (R.engagement) {
      ...
      step({
        ...
        sub: 'R_S = ' + nf(e.RS, 3) + ' → ' + (e.branch === 'innen' ? 'Innengewinde maßgeblich' : 'Bolzengewinde maßgeblich'),
      ...
      step({
        ...
        sub: 'aus Scherquerschnitt des maßgeblichen Gewindes  (C = ' + nf(e.C, 3) + ', C1 = ' + nf(e.C1, 2) + ')',
      ...
      step({
        ...
        formula: (conn === 'ESV') ? 'm_zu = 3·P  (Sackloch)' : 'm_zu = 2·P  (Durchsteck/Mutter)',
